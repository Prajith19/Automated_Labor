...
int Motor_speed = 50; // speed of motor
int LeftRotationSpeed = 50; // Left turn Speed
int RightRotationSpeed = 50; // Right turn Speed
int righttyre = 50; //
int lefttyre = 50; //
//
//Ultrasonic sensor //
int setDistance = 10; // Object detect distance
